...
<div class="bck">
    <div class="container-xxl mid ">
        ...
        ?>
        <form class="mid" action="vendor/posts.php" method="post">
            <input class="mid" type="text" name="id" placeholder="введите номер поста">
            <button class="btn btn-primary mid">Удалить пост</button>
        </form>
        <a href="addingpost.php" class="btn btn-primary mid">добавить пост</a>
    </div>
